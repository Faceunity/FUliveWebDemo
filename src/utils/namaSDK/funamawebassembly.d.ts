...
const FunamaWebAssembly= () => unknown
export interface FunamaWebAssemblyType {
  FUPLATFORM: NAMA.FUPLATFORM    
  FULOGLEVEL: NAMA.FULOGLEVEL    
  FURENDERFEATURE: NAMA.FURENDERFEATURE    
  FUFORMAT: NAMA.FUFORMAT    
  FUTRANSFORM: NAMA.FUTRANSFORM    
  FUAITYPE: NAMA.FUAITYPE    
  FUAIHUMANSEGMODE: NAMA.FUAIHUMANSEGMODE    
  FUAIFACEMODELCONFIG: NAMA.FUAIFACEMODELCONFIG    
  FUAIFACEALGORITHMCONFIG: NAMA.FUAIFACEALGORITHMCONFIG    
  FUAIMACHINETYPE: NAMA.FUAIMACHINETYPE    
  FUAIHUMANMODELCONFIG: NAMA.FUAIHUMANMODELCONFIG    
  FUAIHUMANALGORITHMCONFIG: NAMA.FUAIHUMANALGORITHMCONFIG    
  fuGetVersion: NAMA.fuGetVersion
  fuSetLogLevel: NAMA.fuSetLogLevel
  fuInitGLContext: NAMA.fuInitGLContext
  fuSetup: NAMA.fuSetup
  fuSetPlatform: NAMA.fuSetPlatform
  fuCreateItemFromPackage2: NAMA.fuCreateItemFromPackage2
  fuCreateLiteItemFromPackage: NAMA.fuCreateLiteItemFromPackage
  fuSetDefaultRotationMode: NAMA.fuSetDefaultRotationMode
  fuDestroyItem: NAMA.fuDestroyItem
  fuDestroyAllItems: NAMA.fuDestroyAllItems
  fuDestroyLibData: NAMA.fuDestroyLibData
  fuReleaseGLResources: NAMA.fuReleaseGLResources
  fuOnCameraChange: NAMA.fuOnCameraChange
  fuRenderTextureToCanvas: NAMA.fuRenderTextureToCanvas
  fuRenderBufferToCanvas: NAMA.fuRenderBufferToCanvas
  fuSetInputCameraTextureMatrix: NAMA.fuSetInputCameraTextureMatrix
  fuSetInputCameraBufferMatrix: NAMA.fuSetInputCameraBufferMatrix
  fuSetInputCameraTextureMatrixState: NAMA.fuSetInputCameraTextureMatrixState
  fuSetInputCameraBufferMatrixState: NAMA.fuSetInputCameraBufferMatrixState
  fuItemSetParamd: NAMA.fuItemSetParamd
  fuItemGetParamd: NAMA.fuItemGetParamd
  fuItemSetParams: NAMA.fuItemSetParams
  fuItemGetParams: NAMA.fuItemGetParams
  fuItemSetParamdv: NAMA.fuItemSetParamdv
  fuItemGetParamdv: NAMA.fuItemGetParamdv
  fuIsLibraryInit: NAMA.fuIsLibraryInit
  fuLoadAIModelFromPackage: NAMA.fuLoadAIModelFromPackage
  fuSetMaxFaces: NAMA.fuSetMaxFaces
  fuSetFaceProcessorDetectMode: NAMA.fuSetFaceProcessorDetectMode
  fuIsAIModelLoaded: NAMA.fuIsAIModelLoaded
  fuSetFaceModelConfig: NAMA.fuSetFaceModelConfig
  fuSetFaceAlgorithmConfig: NAMA.fuSetFaceAlgorithmConfig
  fuSetHumanModelConfig: NAMA.fuSetHumanModelConfig
  fuSetHumanAlgorithmConfig: NAMA.fuSetHumanAlgorithmConfig
  fuFaceProcessorSetFaceLandmarkQuality: NAMA.fuFaceProcessorSetFaceLandmarkQuality
  fuFaceProcessorGetNumResults: NAMA.fuFaceProcessorGetNumResults
  fuEnableFrameTimeProfile: NAMA.fuEnableFrameTimeProfile
  fuDisableFrameTimeProfile: NAMA.fuDisableFrameTimeProfile
  CanvasViewport: typeof NAMA.CanvasViewport

   fuCreateItemFromPackage: NAMA.fuCreateItemFromPackage
  fuUnRegisterNativeTexture: NAMA.fuUnRegisterNativeTexture
  fuRegisterNativeTexture: NAMA.fuRegisterNativeTexture
}
export default FunamaWebAssembly